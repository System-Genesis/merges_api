...
export const recoveryAll = async (_req: Request, res: Response): Promise<void> => {
    ...
    logger.info(false, 'APP', 'POST request succeeded - All', _req.originalUrl);
};
...
export const recoveryByIdentifier = async (req: Request, res: Response): Promise<void> => {
    ...
    logger.info(false, 'APP', 'POST request succeeded - Identifier', req.originalUrl, { id: req.params.identifier });
};
...
export const recoveryBySource = async (req: Request, res: Response): Promise<void> => {
    ...
    logger.info(false, 'APP', 'POST request succeeded - Source', req.originalUrl);
};
...
export const recoveryUpdatedAfter = async (req: Request, res: Response): Promise<void> => {
    ...
    logger.info(false, 'APP', 'POST request succeeded - Updated From', req.originalUrl);
};
