...
export const getAll = async (_req: Request, res: Response): Promise<void> => {
    ...
    logger.info(true, 'SYSTEM', 'GET request succeeded - All', _req.originalUrl);
};
...
export const getByIdentifier = async (req: Request, res: Response): Promise<void> => {
    ...
    logger.info(true, 'SYSTEM', 'GET request succeeded - Identifier', req.originalUrl, { id: req.params.identifier });
};
...
export const getByDIBySource = async (req: Request, res: Response): Promise<void> => {
    ...
    res.status(entity ? 200 : 404).json(entity || { message: 'Not Found' });
    logger.info(true, 'SYSTEM', 'GET request succeeded - DI By Source', req.originalUrl, { id: req.params.identifier });
};
...
export const getBySource = async (req: Request, res: Response): Promise<void> => {
    ...
    pipeToRes(streamProvider, res);
    logger.info(true, 'SYSTEM', 'GET request succeeded - Source', req.originalUrl);
};
...
export const getUpdatedAfter = async (req: Request, res: Response): Promise<void> => {
    ...
    pipeToRes(streamProvider, res);
    logger.info(true, 'SYSTEM', 'GET request succeeded - Updated From', req.originalUrl);
};
