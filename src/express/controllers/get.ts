...
export const getAll = async (_req: Request, res: Response): Promise<void> => {
    ...
    logger.info(false, 'APP', 'GET request succeeded - All', _req.originalUrl);
};
...
export const getByIdentifier = async (req: Request, res: Response): Promise<void> => {
    ...
    logger.info(false, 'APP', 'GET request succeeded - Identifier', req.originalUrl, { id: req.params.identifier });
};
...
export const getBySource = async (req: Request, res: Response): Promise<void> => {
    ...
    logger.info(false, 'APP', 'GET request succeeded - Source', req.originalUrl);
};
...
export const getUpdatedAfter = async (req: Request, res: Response): Promise<void> => {
    ...
    logger.info(false, 'APP', 'GET request succeeded - Updated From', req.originalUrl);
};
